...
try:
    if os.environ["HEROKU"]:
        ...
        SQLALCHEMY_POOL_RECYCLE = os.environ['SQLALCHEMY_TRACK_MODIFICATIONS']
        SQLALCHEMY_DATABASE_RESET = os.environ['SQLALCHEMY_TRACK_MODIFICATIONS']
    ...
    try:
        ...
        SQLALCHEMY_POOL_RECYCLE = config_vars.SQLALCHEMY_TRACK_MODIFICATIONS
        SQLALCHEMY_DATABASE_RESET = config_vars.SQLALCHEMY_TRACK_MODIFICATIONS
